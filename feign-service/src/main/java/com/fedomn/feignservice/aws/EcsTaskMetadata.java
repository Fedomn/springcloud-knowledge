package com.fedomn.feignservice.aws;
...
public class EcsTaskMetadata {
  ...
  @JsonProperty("PullStartedAt")
  public void setPullStartedAt(String value) {
    this.pullStartedAt = value;
  }
  ...
  @JsonProperty("PullStoppedAt")
  public void setPullStoppedAt(String value) {
    this.pullStoppedAt = value;
  }
}
